...
public class CompilerComponentFactory {
	...
	public static ILexer getLexer(String input) {return new Lexer(input);}
	public static IParser getParser(ILexer lexer) throws LexicalException {return new Parser(lexer);}
